...
draw_set_font(font2);
draw_text_ext_transformed_color(begin_point_x,y-(room_height/20),"BPM: " + string(round(bpm)),5,room_width,global.scale*0.75,global.scale*0.75,0,$999999,$999999,$999999,$999999,1);